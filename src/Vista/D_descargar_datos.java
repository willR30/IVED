 ...
 * @author DELL
 */
public class D_descargar_datos extends javax.swing.JDialog {

    /**
     * Creates new form D_descargar_datos
     */
    private String path="";
    public D_descargar_datos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //propiedades iniciales
        this.setLocationRelativeTo(null);
        this.setIconImage(new ImageIcon(getClass().getResource("/img/IVED_isotipo.png")).getImage());
        this.setTitle("IVED-Descargar datos");
    }
    ...
    private void initComponents() {
        ...
        btn_actualizar_usuario.setText("Guardar");
        ...
        jLabel8.setText("Ruta donde guardar los datos:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addComponent(btn_actualizar_usuario, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) throws UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(D_descargar_datos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                D_descargar_datos dialog = new D_descargar_datos(new javax.swing.JFrame(), true);
    ...
    private rsbuttom.RSButtonMetro btn_buscar5;
    ...
    private rsbuttom.RSButtonMetro btn_entrar2;
